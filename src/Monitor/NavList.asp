...
a.Sqlstring="select ControllerId,(cast(ControllerId as nvarchar(20))+'-'+ControllerNumber+'-'+Location) as ControllerNumber from Controllers"&strWhere&" "&"order by "& sidx & " " & sord
