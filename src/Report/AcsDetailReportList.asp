...
'属性
strExportPeroperty=""
if strProperty <> "" and strProperty <> "-1" then 	'-1为所有属性
...
'	if strExportWhere = "" then 
'		strExportWhere = " where "
'	else
'		strExportWhere = strExportWhere & " and "
'	end if 
'	strExportWhere = strExportWhere & " Controllerid in (select ControllerID from RoleController where UserId in ("&strUserId&") and Permission=1 ) "
'end if 
