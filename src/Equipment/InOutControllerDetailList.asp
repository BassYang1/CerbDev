...
dim a
set a=new JSONClass
a.Sqlstring="select RecordID,ControllerID,InoutPoint,InoutDesc,ScheduleID,ScheduleName,Out1,Out2,Out3,Out4,Out5 from ControllerInout where ControllerID="&strControllerId&" order by InoutPoint "
