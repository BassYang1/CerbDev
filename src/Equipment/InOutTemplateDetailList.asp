...
dim a
set a=new JSONClass
a.Sqlstring="select RecordID,TemplateId,InoutPoint,InoutDesc,ScheduleID,ScheduleName,Out1,Out2,Out3,Out4,Out5 from ControllerTemplateInout where TemplateId='"&strTemplateId&"' order by InoutPoint "
