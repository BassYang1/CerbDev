...
dim a
set a=new JSONClass
'a.Sqlstring="select RecordID,WeekDay,HolidayCode,StartTime1,EndTime1,StartTime2,EndTime2,StartTime3,EndTime3,StartTime4,EndTime4,StartTime5,EndTime5 from ControllerScheduleDetail Where ID="&ScheduleID&" "&"order by "& sidx & " " & sord
a.Sqlstring="select RecordID,WeekDay,case EnableBell when 1 then '是' ELSE '否' END as EnableBell,Voice,Out,Time1,Time2,Time3,Time4,Time5,Time6,Time7,Time8,Time9,Time10 from Bell order by recordid "
