$(document).ready(function () {
    ...
    jQuery("#DataGrid").jqGrid({
        ...
        colModel: [
            ...
            {
                name: 'Note', index: 'Note', align: 'center', width: 140, editable: true, hidden: false, editrules: { required: false, edithidden: true }, viewable: false, search: false,
    ...
    jQuery("#DataGrid").jqGrid('navGrid', '#DataGrid_toppager',
        {
            edit: iapprove, add: iapply, del: irevoke, view: iview, refresh: irefresh, search: false, edittext: strapprovetext, addtext: strapplytext, deltext: strrevoketext, searchtext: strsearchtext, refreshtext: strrefreshtext, viewtext: strviewtext,
