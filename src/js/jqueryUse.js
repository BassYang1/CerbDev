...
jQuery.isString = function(o) {
	return jQuery.getType(o) == "string";
}

jQuery.encodeURL = function(s) {
...
jQuery.param = function( a, traditional ) {
	var prefix,
		...
		add = function( key, value ) {
			...
			if(jQuery.isString(value) == false)
				s[ s.length ] = encodeURIComponent( key ) + "=" + encodeURIComponent( value );
			else
				s[ s.length ] = jQuery.encodeURL( key ) + "=" + jQuery.encodeURL( value );	// mike
		};
