...
/* Database: CerbDb                                             */
/*==============================================================*/
create database CerbDb collate Chinese_PRC_CI_AS
go
...
insert into Users(UserID,LoginName,UserPassword,OperPermissions,OperPermDesc) Values(1,'Admin','Admin',1,'System Administrator')
SET IDENTITY_INSERT Users  OFF
GO

SET IDENTITY_INSERT [ControllerTemplates]  ON
insert ControllerTemplates(TemplateId,TemplateType,TemplateName) values(1,'2', '0 - 24H In & Out') --24H时间表ID需为1
insert ControllerTemplates(TemplateId,TemplateType,TemplateName) values(2,'1' , '0 - Hong Kong Holiday')
insert ControllerTemplates(TemplateId,TemplateType,TemplateName) values(4,'1' , '2 - Other Holiday')
insert ControllerTemplates(TemplateId,TemplateType,TemplateName) values(5,'2',	'Nine am to five pm')
insert ControllerTemplates(TemplateId,TemplateType,TemplateName) values(6,'2',	'Nine am to five pm(5.5 Days)')
insert ControllerTemplates(TemplateId,TemplateType,TemplateName) values(7,'3',	'In/Out Template')
SET IDENTITY_INSERT [ControllerTemplates]  OFF
GO
INSERT [ControllerTemplates] ([TemplateType],[TemplateName],[EmployeeDesc],[EmployeeController],[EmployeeScheID],[EmployeeDoor],[ValidateMode]) VALUES ( '4','Reg All Employees','0 - All Employees','0 - All Controllers',1,'3 - Double Door','0 - Card')

GO 
INSERT ControllerTemplateHoliday (TemplateId,[HolidayNumber],[HolidayName],[HolidayDate]) VALUES ( 2,1,'New Year Day','01-01')
INSERT ControllerTemplateHoliday (TemplateId,[HolidayNumber],[HolidayName],[HolidayDate]) VALUES ( 2,2,'Christmas Day','12-25')

INSERT ControllerTemplateHoliday (TemplateId,[HolidayNumber],[HolidayName],[HolidayDate]) VALUES ( 4,1,'New Year Day','01-01')
GO
...
GO
INSERT ControllerTemplateInout ([TemplateId],[InoutPoint],[InoutDesc],[ScheduleID],[ScheduleName],[Out1],[Out2]) VALUES ( 7,1,'Button1',1,'0 - 24H In & Out',3000,0)
...
INSERT ControllerTemplateInout ([TemplateId],[InoutPoint],[InoutDesc],[Out1],[Out2]) VALUES ( 7,6,'Card Reader1-Valid Card',3000,0)
INSERT ControllerTemplateInout ([TemplateId],[InoutPoint],[InoutDesc],[Out1],[Out2]) VALUES ( 7,7,'Card Reader1-Illegal Card',0,3000)
INSERT ControllerTemplateInout ([TemplateId],[InoutPoint],[InoutDesc],[Out1],[Out2]) VALUES ( 7,8,'Card Reader1-Illegal Time Period',0,0)
INSERT ControllerTemplateInout ([TemplateId],[InoutPoint],[InoutDesc],[Out1],[Out2]) VALUES ( 7,9,'Card Reader1-Anti Passback',0,0)
INSERT ControllerTemplateInout ([TemplateId],[InoutPoint],[InoutDesc],[Out1],[Out2]) VALUES ( 7,10,'Card Reader2-Valid Card',3000,0)
INSERT ControllerTemplateInout ([TemplateId],[InoutPoint],[InoutDesc],[Out1],[Out2]) VALUES ( 7,11,'Card Reader2-Illegal Card',0,3000)
INSERT ControllerTemplateInout ([TemplateId],[InoutPoint],[InoutDesc],[Out1],[Out2]) VALUES ( 7,12,'Card Reader2-Illegal Time Period',0,0)
INSERT ControllerTemplateInout ([TemplateId],[InoutPoint],[InoutDesc],[Out1],[Out2]) VALUES ( 7,13,'Card Reader2-Anti Passback',0,0)
INSERT ControllerTemplateInout ([TemplateId],[InoutPoint],[InoutDesc],[Out1],[Out2]) VALUES ( 7,14,'Door-NO',0,0)
INSERT ControllerTemplateInout ([TemplateId],[InoutPoint],[InoutDesc],[Out1],[Out2]) VALUES ( 7,15,'Door-NC',0,0)	
GO
insert tablefieldcode(FieldId,Content) values( 1,    'China'   )
insert tablefieldcode(FieldId,Content) values( 2,    'Beijing'  )
...
insert tablefieldcode(FieldId,Content) values( 2,    '辽宁省'  )
insert tablefieldcode(FieldId,Content) values( 2,    '吉林省'  )
insert tablefieldcode(FieldId,Content) values( 2,    '黑龙江省' )
insert tablefieldcode(FieldId,Content) values( 2,    '上海市'  )
insert tablefieldcode(FieldId,Content) values( 2,    '江苏省'  )
...
insert tablefieldcode(FieldId,Content) values( 2,    '山东省'  )
...
insert tablefieldcode(FieldId,Content) values( 2,    '广东省'  )
insert tablefieldcode(FieldId,Content) values( 2,    '海南省'  )
insert tablefieldcode(FieldId,Content) values( 2,    '重庆市'  )
insert tablefieldcode(FieldId,Content) values( 2,    '四川省'  )
insert tablefieldcode(FieldId,Content) values( 2,    '贵州省'  )
insert tablefieldcode(FieldId,Content) values( 2,    '云南省'  )
insert tablefieldcode(FieldId,Content) values( 2,    '陕西省'  )
insert tablefieldcode(FieldId,Content) values( 2,    '甘肃省'  )
insert tablefieldcode(FieldId,Content) values( 2,    '青海省'  )
insert tablefieldcode(FieldId,Content) values( 2,    '台湾省'  )
insert tablefieldcode(FieldId,Content) values( 2,    '内蒙古自治区'   )
insert tablefieldcode(FieldId,Content) values( 2,    '广西壮族自治区'  )
insert tablefieldcode(FieldId,Content) values( 2,    '西藏自治区')
insert tablefieldcode(FieldId,Content) values( 2,    '宁夏回族自治区'  )
insert tablefieldcode(FieldId,Content) values( 2,    '新疆维吾尔自治区' )*/
insert tablefieldcode(FieldId,Content) values( 2,    'Hongkong'  )
insert tablefieldcode(FieldId,Content) values( 2,    'Macao'  )

insert tablefieldcode(FieldId,Content) values( 3,    'General Manager'  )
insert tablefieldcode(FieldId,Content) values( 3,    'Director'  )
insert tablefieldcode(FieldId,Content) values( 3,    'Manager')
insert tablefieldcode(FieldId,Content) values( 3,    'Supervisor'  )
insert tablefieldcode(FieldId,Content) values( 3,    'Employee' )

insert tablefieldcode(FieldId,Content) values( 4,    'General Manager（CEO）'  )
insert tablefieldcode(FieldId,Content) values( 4,    'Deputy General Manager'  )
insert tablefieldcode(FieldId,Content) values( 4,    'Human Resources Director'  )
insert tablefieldcode(FieldId,Content) values( 4,    'Finance Director'  )
insert tablefieldcode(FieldId,Content) values( 4,    'Marketing Director'  )
insert tablefieldcode(FieldId,Content) values( 4,    'Market Director'  )
insert tablefieldcode(FieldId,Content) values( 4,    'Sales Director'  )
insert tablefieldcode(FieldId,Content) values( 4,    'Operating Director'  )
insert tablefieldcode(FieldId,Content) values( 4,    'Technology Director'  )
insert tablefieldcode(FieldId,Content) values( 4,    'Assistant General Manager'  )
insert tablefieldcode(FieldId,Content) values( 4,    'Human Resources Manager'  )
insert tablefieldcode(FieldId,Content) values( 4,    'Recruitment Supervisor'  )
insert tablefieldcode(FieldId,Content) values( 4,    'Trainer'  )
insert tablefieldcode(FieldId,Content) values( 4,    'Supervisor for Performance Examination'  )
insert tablefieldcode(FieldId,Content) values( 4,    'Salary Analyst'  )
insert tablefieldcode(FieldId,Content) values( 4,    'Finance Manager'  )
insert tablefieldcode(FieldId,Content) values( 4,    'Audit Commissioner'  )
insert tablefieldcode(FieldId,Content) values( 4,    'Cashier'  )
insert tablefieldcode(FieldId,Content) values( 4,    'Clerk'  )
insert tablefieldcode(FieldId,Content) values( 4,    'Executive'  )
insert tablefieldcode(FieldId,Content) values( 4,    'Secretary'  )
insert tablefieldcode(FieldId,Content) values( 4,    'Filer'  )
insert tablefieldcode(FieldId,Content) values( 4,    'Receptionist'  )
insert tablefieldcode(FieldId,Content) values( 4,    'Manager of Marketing Department'  )
insert tablefieldcode(FieldId,Content) values( 4,    'Supervisor for Customer Development'  )
insert tablefieldcode(FieldId,Content) values( 4,    'Supervisor for Market Researcg'  )
insert tablefieldcode(FieldId,Content) values( 4,    'Executive for Business Development'  )
insert tablefieldcode(FieldId,Content) values( 4,    'Commissioner for Media Promotion'  )
insert tablefieldcode(FieldId,Content) values( 4,    'Account Representative'  )
insert tablefieldcode(FieldId,Content) values( 4,    'Art Designer'  )
insert tablefieldcode(FieldId,Content) values( 4,    'Manager of Sales Department'  )
insert tablefieldcode(FieldId,Content) values( 4,    'Sales Representative'  )
insert tablefieldcode(FieldId,Content) values( 4,    'Sales Statistician'  )
insert tablefieldcode(FieldId,Content) values( 4,    'Telemarketing Representative'  )
insert tablefieldcode(FieldId,Content) values( 4,    'R & D Supervisor'  )
insert tablefieldcode(FieldId,Content) values( 4,    'Computer Administrator'  )
insert tablefieldcode(FieldId,Content) values( 4,    'Software Engineer'  )
insert tablefieldcode(FieldId,Content) values( 4,    'Testing Supervisor'  )
insert tablefieldcode(FieldId,Content) values( 4,    'Engineer of Software Testing'  )
insert tablefieldcode(FieldId,Content) values( 4,    'Database Engineer'  )
insert tablefieldcode(FieldId,Content) values( 4,    'System Analyst'  )
insert tablefieldcode(FieldId,Content) values( 4,    'Senior Programmer'  )
insert tablefieldcode(FieldId,Content) values( 4,    'Network Engineer'  )
insert tablefieldcode(FieldId,Content) values( 4,    'Network Administrator'  )

insert tablefieldcode(FieldId,Content) values( 5,    'Primary School'  )
insert tablefieldcode(FieldId,Content) values( 5,    'Middle School'  ) --初中
insert tablefieldcode(FieldId,Content) values( 5,    'Technical Secondary School'  )
insert tablefieldcode(FieldId,Content) values( 5,    'Senior Middle School'  )
insert tablefieldcode(FieldId,Content) values( 5,    'Junior College'  )
insert tablefieldcode(FieldId,Content) values( 5,    'Undergraduate Course'  )
insert tablefieldcode(FieldId,Content) values( 5,    'Master'  )
insert tablefieldcode(FieldId,Content) values( 5,    'Doctor'  )

insert tablefieldcode(FieldId,Content) values( 6,    '0 - Card'  )
insert tablefieldcode(FieldId,Content) values( 6,    '1 - Fingerprint'  )
insert tablefieldcode(FieldId,Content) values( 6,    '2 - Card+Fingerprint'  )
insert tablefieldcode(FieldId,Content) values( 6,    '3 - Card+Password'  )
GO
...
--------------------------------------------------------------------------------------- ----------- ---- ---------------------------------------------------- ---- ---------------------------------------------------- ---- ---------------------------------------------------- ---- ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- ---- 
insert options(VariableId,VariableName,VariableDesc,VariableValue,VariableType) values( 1 , 'strLate',    'Late(2nd for 1, calculation of late including the time allowed)'    , '1,1,1' , 'str'  )
insert options(VariableId,VariableName,VariableDesc,VariableValue,VariableType) values( 2 , 'strLeaveEarly'  , 'LeaveEarly'  , '1,1,1'  , 'str'  )
insert options(VariableId,VariableName,VariableDesc,VariableValue,VariableType) values( 3 , 'strAbnormity'   , 'Abnormal(1 Absenteeism)'  , '0'  , 'str'  )
insert options(VariableId,VariableName,VariableDesc,VariableValue,VariableType) values( 4 , 'strVacationDesc', 'Vacations description', NULL  , 'str'  )
insert options(VariableId,VariableName,VariableDesc,VariableValue,VariableType) values( 5 , 'strVacationCondition', 'Vacation Condition', NULL  , 'str'  )
insert options(VariableId,VariableName,VariableDesc,VariableValue,VariableType) values( 6 , 'intBasicDay'    , 'Basic annual leave', '7'  , 'int'  )
insert options(VariableId,VariableName,VariableDesc,VariableValue,VariableType) values( 7 , 'strVacationType', 'Incrementally', NULL  , 'str'  )
insert options(VariableId,VariableName,VariableDesc,VariableValue,VariableType) values( 8 , 'intIncreasePerYear'  , 'Increasing number of days ', NULL  , 'int'  )
insert options(VariableId,VariableName,VariableDesc,VariableValue,VariableType) values( 9 , 'strIncreaseType1',    'IncreaseType1',    NULL  , 'str'  )
insert options(VariableId,VariableName,VariableDesc,VariableValue,VariableType) values( 10 , 'strIncreaseType2',    'IncreaseType2',    NULL  , 'int'  )
insert options(VariableId,VariableName,VariableDesc,VariableValue,VariableType) values( 11, 'intMaxVacation' , 'Max Vacation', '12'  , 'str'  )
insert options(VariableId,VariableName,VariableDesc,VariableValue,VariableType) values( 12, 'blnContinueNext', 'Continue Next' , '0'  , 'bln'  )
insert options(VariableId,VariableName,VariableDesc,VariableValue,VariableType) values( 13, 'strWeekendPrompt',    'Weekend Prompt', '0, '  , 'bln'  )
insert options(VariableId,VariableName,VariableDesc,VariableValue,VariableType) values( 14, 'strAskForLeaveOT',    'AskForLeaveOT', '1,30'  , 'str'  )
insert options(VariableId,VariableName,VariableDesc,VariableValue,VariableType) values( 15, 'strOTType', 'OverTime',    '0,0,1,0,30'  , 'str'  )
insert options(VariableId,VariableName,VariableDesc,VariableValue,VariableType) values( 16, 'strTotalCycle'  , 'Total Cycle','0 – This Month,1,0 – This Month,31',    'str'  )
insert options(VariableId,VariableName,VariableDesc,VariableValue,VariableType) values( 17, 'strAbsent', 'Absent',    '1,30'  , 'str'  )
insert options(VariableId,VariableName,VariableDesc,VariableValue,VariableType) values( 18, 'strAnalyseOffDuty'   , 'Analyse Off Duty', '1'  , 'str'  )
insert options(VariableId,VariableName,VariableDesc,VariableValue,VariableType) values( 19, 'strSkipHoliday' , 'Skip Holiday'  , 'PersonalLeave1,SickLeave1,CompensatoryLeave1,MaternityLeave,WeddingLeave,LactationLeave,OtherLeave,OnTrip,AnnualVacation,PublicHoliday,InjuryLeave,FuneralLeave,VisitLeave',  'str'  )
insert options(VariableId,VariableName,VariableDesc,VariableValue,VariableType) values( 20, 'blnAnalyseWorkDay'   , 'Analyse WorkDay', '0'  , 'bln'  )
insert options(VariableId,VariableName,VariableDesc,VariableValue,VariableType) values( 21, 'blnautoTotal'   , 'Auto Total', '1'  , NULL               )
insert options(VariableId,VariableName,VariableDesc,VariableValue,VariableType) values( 22, 'datAutotime',    'Auto time' , '10:00'  , NULL               )
insert options(VariableId,VariableName,VariableDesc,VariableValue,VariableType) values( 23, 'blnTotalDimission',    'Total Dimission' , '0'  , 'bln'  )
insert options(VariableId,VariableName,VariableDesc,VariableValue,VariableType) values( 24, 'intWorkTime',    'WorkTime' , '8'  , 'str'  )
Insert into options (VariableId,variablename,variabledesc, variabletype, variablevalue) values (31,'strOnduty','Onduty','str','0,1')
insert into options(VariableId,VariableName,VariableDesc,VariableType,VariableValue) values(32,'strTotal','Total(2,1,1,2015-04-1,2015-4-12)',null,null)
insert into options(VariableId,VariableName,VariableDesc,VariableType,VariableValue) values(33,'strEmail','Email','str','1')
...
INSERT [Tables] ([TableId],[TableName],[TableDesc]) VALUES ( 1,'AttendanceShifts','Normal Shifts')
INSERT [Tables] ([TableId],[TableName],[TableDesc]) VALUES ( 2,'Tables','Tables')
INSERT [Tables] ([TableId],[TableName],[TableDesc]) VALUES ( 6,'TableStructure','Table Structure')
INSERT [Tables] ([TableId],[TableName],[TableDesc]) VALUES ( 7,'AttendanceSignIn','Sign Card ')
INSERT [Tables] ([TableId],[TableName],[TableDesc]) VALUES ( 10,'AttendanceHoliday','Statutory holidays')
INSERT [Tables] ([TableId],[TableName],[TableDesc]) VALUES ( 11,'Company','Company')
INSERT [Tables] ([TableId],[TableName],[TableDesc]) VALUES ( 12,'Employees','Employees')
INSERT [Tables] ([TableId],[TableName],[TableDesc]) VALUES ( 13,'Departments','Departments')
INSERT [Tables] ([TableId],[TableName],[TableDesc]) VALUES ( 14,'RoleDepartment','Department Role')
INSERT [Tables] ([TableId],[TableName],[TableDesc]) VALUES ( 15,'RoleController','Controller Role')
INSERT [Tables] ([TableId],[TableName],[TableDesc]) VALUES ( 16,'BrushCardAcs','Access Brush Card')
INSERT [Tables] ([TableId],[TableName],[TableDesc]) VALUES ( 17,'AttendanceTotal','Attendance Total')
INSERT [Tables] ([TableId],[TableName],[TableDesc]) VALUES ( 18,'AttendanceDetail','Attendance Detail')
INSERT [Tables] ([TableId],[TableName],[TableDesc]) VALUES ( 19,'BrushCardAttend','Attendance Brush Card')
INSERT [Tables] ([TableId],[TableName],[TableDesc]) VALUES ( 20,'ControllerDataSync','Controller Sync')
INSERT [Tables] ([TableId],[TableName],[TableDesc]) VALUES ( 21,'Controllers','Controllers')
INSERT [Tables] ([TableId],[TableName],[TableDesc]) VALUES ( 22,'ControllerHoliday','Controller Holiday')
INSERT [Tables] ([TableId],[TableName],[TableDesc]) VALUES ( 24,'ControllerTemplateHoliday','Controller Holiday Template')
INSERT [Tables] ([TableId],[TableName],[TableDesc]) VALUES ( 25,'ControllerTemplates','Controller Templates')
INSERT [Tables] ([TableId],[TableName],[TableDesc]) VALUES ( 26,'ControllerSchedule','Controller Schedule')
INSERT [Tables] ([TableId],[TableName],[TableDesc]) VALUES ( 28,'ControllerTemplateSchedule','Controller Schedule Template')
INSERT [Tables] ([TableId],[TableName],[TableDesc]) VALUES ( 29,'ControllerInout','Controller Inout')
INSERT [Tables] ([TableId],[TableName],[TableDesc]) VALUES ( 30,'ControllerTemplateInout','Controller Inout Template')
INSERT [Tables] ([TableId],[TableName],[TableDesc]) VALUES ( 31,'ControllerEmployee','Controller Employee')
INSERT [Tables] ([TableId],[TableName],[TableDesc]) VALUES ( 32,'TempShifts','TempShifts')
INSERT [Tables] ([TableId],[TableName],[TableDesc]) VALUES ( 33,'AttendanceAskForLeave','AskForLeave')
INSERT [Tables] ([TableId],[TableName],[TableDesc]) VALUES ( 34,'LogEvent','LogEvent')
INSERT [Tables] ([TableId],[TableName],[TableDesc]) VALUES ( 35,'AttendanceOndutyRule','AttendanceOndutyRule')
INSERT [Tables] ([TableId],[TableName],[TableDesc]) VALUES ( 36,'AttendanceOnDutyRuleChange','AttendanceOnDutyRuleChange')
INSERT [Tables] ([TableId],[TableName],[TableDesc]) VALUES ( 37,'EventRecord','Button Event Record')
INSERT [Tables] ([TableId],[TableName],[TableDesc]) VALUES ( 38,'Options','Options')
INSERT [Tables] ([TableId],[TableName],[TableDesc]) VALUES ( 39,'Users','Users')
INSERT [Tables] ([TableId],[TableName],[TableDesc]) VALUES ( 40,'AttendanceTotalYear','AttendanceTotalYear')
INSERT [Tables] ([TableId],[TableName],[TableDesc]) VALUES ( 41,'AttendanceOT','OverTime')
INSERT [Tables] ([TableId],[TableName],[TableDesc]) VALUES ( 42,'TotalMonth','TotalMonth')
INSERT [Tables] ([TableId],[TableName],[TableDesc]) VALUES ( 43,'CombinationDoor','CombinationDoor')
INSERT [Tables] ([TableId],[TableName],[TableDesc]) VALUES ( 45,'TableFieldCode','Table Field Code')
...
INSERT [TableStructure] ([FieldId],[TableId],[TableName],[FieldName],[FieldDesc],[FieldType],[AllowView],[ViewOrder]) VALUES ( 546,21,'Controllers','ScreenType','屏保类型','nvarchar(50)',0,43)
...
INSERT [AttendanceOndutyRule] ([RuleId],[EmployeeDesc],[EmployeeCode],[OnDutyMode],[NoBrushCard],[Monday1],[Tuesday1],[Wednesday1],[Thursday1],[Friday1],[Saturday1],[Sunday1]) VALUES ( 1,'Incumbency Not equal Dimission','((left(IncumbencyStatus,1) not in(''1'')))','1-Single Week Cycle',0,'1-Normal Shift','1-Normal Shift','1-Normal Shift','1-Normal Shift','1-Normal Shift','1-Normal Shift','1-Normal Shift')
SET IDENTITY_INSERT [AttendanceOndutyRule] OFF

SET IDENTITY_INSERT [AttendanceOnDutyRuleChange] ON
INSERT [AttendanceOnDutyRuleChange] ([ChangeId],[ChangeDate],[RuleId],[EmployeeDesc],[EmployeeCode],[OnDutyMode],[NoBrushCard],[Monday1],[Tuesday1],[Wednesday1],[Thursday1],[Friday1],[Saturday1],[Sunday1]) VALUES ( 1,'2011-05-01 0:00:00',1,'Incumbency Not equal Dimission','((left(IncumbencyStatus,1) not in(''1'')))','1-Single Week Cycle',0,'1-Normal Shift','1-Normal Shift','1-Normal Shift','1-Normal Shift','1-Normal Shift','1-Normal Shift','1-Normal Shift')
SET IDENTITY_INSERT [AttendanceOnDutyRuleChange] OFF

SET IDENTITY_INSERT [AttendanceShifts] ON
INSERT [AttendanceShifts] ([ShiftId],[ShiftName],[StretchShift],[Degree],[Night],[FirstOnDuty],[ShiftTime],[AonDuty],[AonDutyStart],[AonDutyEnd],[AoffDuty],[AoffDutyStart],[AoffDutyEnd],[ArestTime],[AcalculateLate],[AcalculateEarly],[Overtime]) VALUES ( 1,'Normal Shift',0,1,1,'0',8.00,'1900-01-01 9:00:00','1900-01-01 6:00:00','1900-01-01 13:29:59','1900-01-01 18:00:00','1900-01-01 13:30:00','1900-01-02 5:59:59',60,5,0,0)
SET IDENTITY_INSERT [AttendanceShifts] OFF

SET IDENTITY_INSERT [TempShifts] ON
INSERT [TempShifts] ([TempShiftID],[ShiftType],[ShiftId],[ShiftName],[StretchShift],[Degree],[Night],[FirstOnDuty],[ShiftTime],[AonDuty],[AonDutyStart],[AonDutyEnd],[AoffDuty],[AoffDutyStart],[AoffDutyEnd],[ArestTime],[Overtime]) VALUES ( 1,'0',1,'Normal Shift',0,1,1,'0',8.00,'1900-01-01 9:00:00','1900-01-01 6:00:00','1900-01-01 13:29:59','1900-01-01 18:00:00','1900-01-01 13:30:00','1900-01-02 5:59:59',60,0)
...
Create   PROCEDURE pPagePROCTables
	--表名 单个表就写表名就可以了
	--多个表关联这样写：Users inner join UserRole on Users.UserID=UserRole.UserID
    @tblName      varchar(2000),
	--主键字段名        
    @fldName      varchar(50),        
	--返回的列,*表示所有列,多表：表名.字段名
    @listFldName      varchar(2000), 
	--排序的列名：
    @orderFldName      varchar(50),
	--排序列的类型：如int,varchar等等
	...
	--为配合JSON的写法，显示需要哪些字段及字段顺序.若分布后与其它表有关联，则写成TB.
	@strShowField    varchar(2000) = ''	,
	--分页后再与其它表关联。分页后的数据集表名为TB,写法：left join Controllers C on TB.Controllerid=C.Controllerid
...
-------------------------------考勤原始刷卡行转列存储过程(仅支持SQL2005及以上数据库)-----------------------
SET QUOTED_IDENTIFIER ON 
GO
SET ANSI_NULLS ON 
GO
...
Create   PROCEDURE pGetBrushCardRowToCol
	...
	--截止日期        
    @endTime		varchar(50), 
	--显示日期范围所有行 1显示所有行，0显示仅有刷卡数据的行
    @showAllRow		bit = 1,         
	--查询的条件(不加where)  如： Employeeid = 1 or card=123         
...
--返回列不能包含Employeeid,因为非法卡Employeeid为0
...
begin 
	...
	set @TotalRecord = @totalDays+1 --总记录数
	-- 返回总记录数和总页数
...
OPEN My_Cursor; --打开游标
FETCH NEXT FROM My_Cursor INTO @EmployeeId,@DepartmentName,@Name,@Number,@Card; --读取第一行数据,并将值保存于变量中
WHILE @@FETCH_STATUS = 0
    ...
    --调用pGetBrushCardRowToCol行转列，并将数据集存储于#tempBrushCard表中
	...
	insert into #tempBrushCard(DepartmentName,Name,Number,Card,Brushtime1,Brushtime2)
		...
		from #tempBrushCardSingle where ISNULL(Brushtime2,'1')<>'0' --Brushtime2为0，表示存储过程返回的第二个记录集，这里不取。

        FETCH NEXT FROM My_Cursor INTO @EmployeeId,@DepartmentName,@Name,@Number,@Card; --读取下一行数据
    END
...
WHILE @@FETCH_STATUS = 0
    BEGIN
		...
		select 0,convert(varchar(10),OnDutyDate, 121) as OnDutyDate1,(case Nobrushcard when 1 then (case Substring(OnDutyType, 1, 1) when ''0'' then ''(Card Exempted)'' else '''' end)  else '''' end) as 
...
update #AttendanceDetail set ondutytype='0-Usual' where shiftid is not null
update #AttendanceDetail set ondutytype='0-Usual' where shiftid=0 and shiftname is not null--规则中排了0-休息的初始班次名为'休息。'
update #AttendanceDetail set ondutytype='1-Rest' where shiftid=0 and shiftname is null--规则中排了0-休息的初始班次名为'休息。'

update #AttendanceDetail set ondutytype='0-Usual' from attendanceholiday b where #AttendanceDetail.ondutydate=b.transposaldate  and #AttendanceDetail.templateid=b.templateid
update #AttendanceDetail set ondutytype='2-Holiday' from attendanceholiday b where #AttendanceDetail.ondutydate=b.HolidayDate and left(#AttendanceDetail.ondutytype,1)<>'1' and #AttendanceDetail.templateid=b.templateid
...
update #AttendanceDetail set shiftname='Rest' where shiftid=0 and shiftname is null--规则中排了0-休息的初始班次名为'休息。'
...
--'处理上班性质
Update #Attendancedetail set Result1= case when latetime1>0 then 'Late' else result1 end, 
				  Result2= case when LeaveEarlytime1>0 then 'Leave Early' else Result2 end, 
				  Result3= case when Latetime2>0 then 'Late' else Result3 end, 
				  Result4= case when LeaveEarlyTime2>0 then 'Leave Early' else Result4 end, 
				  Result5= case when latetime3>0 then 'Late' else Result5 end, 
				  Result6 =case when LeaveEarlytime3>0 then 'Leave Early' else Result6 end 
Update #attendancedetail set Result1= case when onduty1 is null and result1 is null then 'Unread' when Onduty1 is not null and result1 is null then 'Usual' else Result1 end, 
				  Result2= case When offduty1 is null and result2 is null then 'Unread' when offduty1 is not null and result2 is null then 'Usual' else Result2 end 
				 where Degree>=1 and NoBrushcard<>1 
Update #attendancedetail set Result3= case when onduty2 is null and result3 is null then 'Unread' when Onduty2 is not null and result3 is null then 'Usual' else Result3 end, 
				  Result4= case When offduty2 is null and result4 is null then 'Unread' when offduty2 is not null and result4 is null then 'Usual' else Result4 end 
				 where Degree>=2 and NoBrushcard<>1 
Update #attendancedetail set Result5= case when onduty3 is null and result5 is null then 'Unread' when Onduty3 is not null and result5 is null then 'Usual' else Result5 end, 
				  Result6= case When offduty3 is null and result6 is null then 'Unread' when offduty3 is not null and result6 is null then 'Usual' else Result6 end 
				 where Degree=3 and NoBrushcard<>1 
Update #Attendancedetail set result1=null ,result2=null
				where left(ondutytype,1)='2' and degree>=1 and (result1 ='Unread' and result2='Unread')
Update #Attendancedetail set result3=null ,result4=null
				where left(ondutytype,1)='2' and degree>=2 and (result3 ='Unread' and result4='Unread')
Update #Attendancedetail set result5=null ,result6=null
				where left(ondutytype,1)='2' and degree>=3 and (result5 ='Unread' and result6='Unread')
...
if @strAbnormity='1'
	Begin
		Update #Attendancedetail Set Absent= (datediff(mi,ondutydate+Aonduty,Ondutydate+AOffduty)-isnull(ArestTime,0))/60.00/isnull(ShiftTime,8)
		         Where Degree=1  and noBrushcard <> 1 and (Onduty1 is null or Offduty1 is null) and (result1  ='Unread' or result2  ='Unread')  and Left(ondutytype,1)<>'1' 
		Update #Attendancedetail Set Absent= Case when ((Onduty1 is null or Offduty1 is null) and (result1  ='Unread' or result2  ='Unread')) and ((Onduty2 is null or Offduty2 is null) and (result3  ='Unread' or result4  ='Unread')) Then ((datediff(mi,ondutydate+Aonduty,Ondutydate+AOffduty)+datediff(mi,Ondutydate+BOnduty,Ondutydate+BOffduty))-isnull(Aresttime,0)-isnull(Bresttime,0))/60.00/isnull(ShiftTime,8) 
		         When ((Onduty1 is null or Offduty1 is null) and (result1  ='Unread' or result2  ='Unread')) and Onduty2 is not null and Offduty2 is not null Then (datediff(mi,ondutydate+Aonduty,Ondutydate+AOffduty)-isnull(ArestTime,0))/60.00/isnull(ShiftTime,8)
		         When  (Onduty1 is not null and Offduty1 is not null) and ((Onduty2 is null or Offduty2 is null) and (result3  ='Unread' or result4  ='Unread')) Then (datediff(mi,Ondutydate+BOnduty,Ondutydate+BOffduty)-isnull(BrestTime,0))/60.00/isnull(ShiftTime,8) end
		         Where Degree=2 and noBrushcard <> 1  and Left(ondutytype,1)<>'1'
		Update #Attendancedetail Set Absent=Case when ((Onduty1 is null or Offduty1 is null) and (result1  ='Unread' or result2  ='Unread')) and ((Onduty2 is null or Offduty2 is null) and (result3  ='Unread' or result4  ='Unread')) and ((Onduty3 is null or Offduty3 is null) and (result5  ='Unread' or result6  ='Unread')) Then (datediff(mi,ondutydate+Aonduty,Ondutydate+AOffduty)+datediff(mi,Ondutydate+BOnduty,Ondutydate+BOffduty)+datediff(mi,ondutydate+Conduty,ondutydate+Coffduty)-isnull(ArestTime,0)-isnull(BrestTime,0)-isnull(CrestTime,0))/60.00/isnull(ShiftTime,8) 
		         When ((Onduty1 is null or Offduty1 is null) and (result1  ='Unread' Or result2  ='Unread')) and ((Onduty2 is null or Offduty2 is null) and (result3  ='Unread' or result4  ='Unread')) and (Onduty3 is not null and Offduty3 is not null) Then (datediff(mi,ondutydate+Aonduty,Ondutydate+AOffduty)+datediff(mi,Ondutydate+BOnduty,Ondutydate+BOffduty)-isnull(Aresttime,0)-isnull(BrestTime,0))/60.00/isnull(ShiftTime,8) 
		         When ((Onduty1 is null or Offduty1 is null) and (result1  ='Unread' or result2  ='Unread')) and (Onduty2 is not null and Offduty2 is not null) and (Onduty3 is not null and Offduty3 is not null) Then (datediff(mi,ondutydate+Aonduty,Ondutydate+AOffduty)-isnull(ArestTime,0))/60.00/isnull(ShiftTime,8) 
		         When (Onduty1 is not null and  Offduty1 is not null) and ((Onduty2 is null or Offduty2 is null) and (result3  ='Unread' or result4  ='Unread')) and (Onduty3 is not null and Offduty3 is not null) Then (datediff(mi,Ondutydate+BOnduty,Ondutydate+BOffduty)-isnull(Bresttime,0))/60.00/isnull(ShiftTime,8) 
		         When (Onduty1 is not null and  Offduty1 is not null) and (Onduty2 is not null and Offduty2 is not null) and ((Onduty3 is null or Offduty3 is  null) and (result5  ='Unread' or result6  ='Unread')) Then (datediff(mi,Ondutydate+COnduty,Ondutydate+COffduty)-isnull(Cresttime,0))/60.00/isnull(ShiftTime,8) 
		         When (Onduty1 is not null and  Offduty1 is not null) and ((Onduty2 is null or Offduty2 is null) and (result3  ='Unread' or result4  ='Unread'))  and ((Onduty3 is null or Offduty3 is null) and (result5  ='Unread' or result6  ='Unread')) Then (datediff(mi,ondutydate+Bonduty,Ondutydate+BOffduty)+datediff(mi,Ondutydate+Conduty,Ondutydate+COffduty)-isnull(Bresttime,0)-isnull(Cresttime,0))/60.00/isnull(ShiftTime,8) 
		         When ((Onduty1 is null or Offduty1 is null) and (result1  ='Unread' or result2  ='Unread')) and (Onduty2 is not null and Offduty2 is not null) and ((Onduty3 is  null or Offduty3 is null) and (result5  ='Unread' Or result6  ='Unread')) Then (datediff(mi,ondutydate+Aonduty,Ondutydate+AOffduty)+datediff(mi,Ondutydate+COnduty,Ondutydate+COffduty)-isnull(Aresttime,0)-isnull(CrestTime,0))/60.00/isnull(ShiftTime,8) end 
...
-- 			end		
		...
		Update #Attendancedetail set LateTime1=0,LeaveEarlyTime1=0 
			 Where Degree>=1  and noBrushcard <> 1 and  (result1 ='Unread' or result2 ='Unread')  and Left(ondutytype,1)<>'1' 
		Update #Attendancedetail set Latetime2=0,LeaveEarlytime2=0 
			 Where Degree>=2  and noBrushcard <> 1 and  (result3 ='Unread' or result4 ='Unread')  and Left(ondutytype,1)<>'1' 
		Update #Attendancedetail set Latetime3=0,LeaveEarlytime3=0 
			 Where Degree>=3  and noBrushcard <> 1 and  (result5 ='Unread' or result6 ='Unread')  and Left(ondutytype,1)<>'1' 
	end
else
	Update #Attendancedetail Set Absent= (Case When Degree>=1 and onduty1 is null and offduty1 is null and result1  ='Unread' and result2  ='Unread' Then (datediff(mi,ondutydate+Aonduty,Ondutydate+AOffduty)-isnull(ArestTime,0)) else 0 end +
			 Case When Degree>=2 and onduty2 is null and Offduty2 is null and result3  ='Unread' and result4  ='Unread' then (datediff(mi,ondutydate+Bonduty,Ondutydate+BOffduty)-isnull(BrestTime,0))  else 0 end + 
			 Case When Degree>=3 and Onduty3 is null and Offduty3 is null and result5  ='Unread' and result6  ='Unread' then (datediff(mi,ondutydate+Conduty,Ondutydate+COffduty)-isnull(CrestTime,0)) else  0 end )/60.00 /isnull(ShiftTime,8)
...
Update #Attendancedetail 
                Set LateCount =(Case When latetime1>0 then 1 else 0 end )+(Case When Latetime2>0 then 1 else 0 end ) +(Case When lateTime3>0 then 1 else 0 end ), 
                    LeaveEarlyCount=(Case When LeaveEarlyTime1>0 then 1 else 0 end )+(Case When LeaveEarlyTime2>0 then 1 else 0 end )+(Case When LeaveEarlyTime3>0 then 1 else 0 end ), 
                    abnormitycount=(Case when (result1 ='Unread'  and result2 <>'Unread') or (result1 <>'Unread'  and result2 ='Unread') then 1 else 0 end ) +(Case When (result3 ='Unread'  and result4 <>'Unread')or (result3 <>'Unread'  and result4 ='Unread') then 1 else 0 end )+(Case When (result5 ='Unread'  and result6 <>'Unread') or (result5 <>'Unread'  and result6 ='Unread') then 1 else 0 end )
	where nobrushcard=0
...
INSERT [Employees] ([EmployeeId],[DepartmentID],[Card],[Number],[Name],[Sex],[Knowledge],[BirthDate],[Country],[NativePlace],[JoinDate],[Position],[Headship],[IncumbencyStatus]) VALUES ( 1,1,1234,'U001','user1','Male','Master','1900-01-01','China','Hongkong','2014-11-10','Human Resources Director','Manager','0 - Incumbent')
INSERT [Employees] ([EmployeeId],[DepartmentID],[Card],[Number],[Name],[Sex],[Knowledge],[BirthDate],[Country],[NativePlace],[JoinDate],[Position],[Headship],[IncumbencyStatus]) VALUES ( 2,1,1235,'U002','user2','Female','Master','1900-01-01','China','Hongkong','2014-11-10','Human Resources Director','Manager','0 - Incumbent')
...
INSERT [ControllerSchedule] ([RecordID],[ControllerId],[ScheduleCode],[TemplateId],[TemplateName],[Status]) VALUES ( 1,1,1,1,'0 - 24H In & Out',0)
...
INSERT [ControllerInout] ([RecordID],[ControllerId],[InoutPoint],[InoutDesc],[ScheduleID],[ScheduleName],[Out1],[Out2],[Out3],[Out4],[Out5],[status]) VALUES ( 1,1,1,'Button1',1,'0 - 24H In & Out',3000,0,0,0,0,0)
...
INSERT [ControllerInout] ([RecordID],[ControllerId],[InoutPoint],[InoutDesc],[Out1],[Out2],[Out3],[Out4],[Out5],[status]) VALUES ( 6,1,6,'Card Reader1-Valid Card',3000,0,0,0,0,0)
INSERT [ControllerInout] ([RecordID],[ControllerId],[InoutPoint],[InoutDesc],[Out1],[Out2],[Out3],[Out4],[Out5],[status]) VALUES ( 7,1,7,'Card Reader1-Illegal Card',0,0,0,0,0,0)
INSERT [ControllerInout] ([RecordID],[ControllerId],[InoutPoint],[InoutDesc],[Out1],[Out2],[Out3],[Out4],[Out5],[status]) VALUES ( 8,1,8,'Card Reader1-Illegal Time Period',0,0,0,0,0,0)
INSERT [ControllerInout] ([RecordID],[ControllerId],[InoutPoint],[InoutDesc],[Out1],[Out2],[Out3],[Out4],[Out5],[status]) VALUES ( 9,1,9,'Card Reader1-Anti Passback',0,0,0,0,0,0)
INSERT [ControllerInout] ([RecordID],[ControllerId],[InoutPoint],[InoutDesc],[Out1],[Out2],[Out3],[Out4],[Out5],[status]) VALUES ( 10,1,10,'Card Reader2-Valid Card',3000,0,0,0,0,0)
INSERT [ControllerInout] ([RecordID],[ControllerId],[InoutPoint],[InoutDesc],[Out1],[Out2],[Out3],[Out4],[Out5],[status]) VALUES ( 11,1,11,'Card Reader2-Illegal Card',0,0,0,0,0,0)
INSERT [ControllerInout] ([RecordID],[ControllerId],[InoutPoint],[InoutDesc],[Out1],[Out2],[Out3],[Out4],[Out5],[status]) VALUES ( 12,1,12,'Card Reader2-Illegal Time Period',0,0,0,0,0,0)
INSERT [ControllerInout] ([RecordID],[ControllerId],[InoutPoint],[InoutDesc],[Out1],[Out2],[Out3],[Out4],[Out5],[status]) VALUES ( 13,1,13,'Card Reader2-Anti Passback',0,0,0,0,0,0)
INSERT [ControllerInout] ([RecordID],[ControllerId],[InoutPoint],[InoutDesc],[Out1],[Out2],[Out3],[Out4],[Out5],[status]) VALUES ( 14,1,14,'Door-NO',0,0,0,0,0,0)
INSERT [ControllerInout] ([RecordID],[ControllerId],[InoutPoint],[InoutDesc],[Out1],[Out2],[Out3],[Out4],[Out5],[status]) VALUES ( 15,1,15,'Door-NC',0,0,0,0,0,0)
...
INSERT INTO TableFieldCode(FieldId,Content) SELECT '7',N'0 - Fingerprint' 
	WHERE NOT EXISTS(SELECT 1 FROM TableFieldCode WHERE FieldId = '7' AND Left(Content,1) = '0');
INSERT INTO TableFieldCode(FieldId,Content) SELECT '7',N'1 - RFID' 
	WHERE NOT EXISTS(SELECT 1 FROM TableFieldCode WHERE FieldId = '7' AND Left(Content,1) = '1');
INSERT INTO TableFieldCode(FieldId,Content) SELECT '7',N'2 - Face' 
