...
WHILE @@FETCH_STATUS = 0
    ...
    Create table #tempBrushCardSingle (Brushtime1 nvarchar(10),Brushtime2 nvarchar(4000))
...
SET NOCOUNT ON
--从模板表获取相关字段
SELECT @strEmDesc=convert(varchar(4000),EmployeeDesc),@strEmCode=convert(varchar(4000),EmployeeCode),@strEmController=ISNULL(EmployeeController,''),
