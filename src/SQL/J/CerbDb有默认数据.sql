...
insert into Users(UserID,LoginName,UserPassword,OperPermissions,OperPermDesc) Values(1,'Admin','Admin',1,'系统管理员')
SET IDENTITY_INSERT Users  OFF
GO

SET IDENTITY_INSERT [ControllerTemplates]  ON
insert ControllerTemplates(TemplateId,TemplateType,TemplateName) values(1,'2', '0 - 24H进出') --24H时间表ID需为1
insert ControllerTemplates(TemplateId,TemplateType,TemplateName) values(2,'1' , '0 - 香港假期表')
insert ControllerTemplates(TemplateId,TemplateType,TemplateName) values(3,'1' , '1 - 大陆假期表')
...
insert ControllerTemplates(TemplateId,TemplateType,TemplateName) values(7,'3',	'输入/出模板')
SET IDENTITY_INSERT [ControllerTemplates]  OFF
GO
INSERT [ControllerTemplates] ([TemplateType],[TemplateName],[EmployeeDesc],[EmployeeController],[EmployeeScheID],[EmployeeDoor],[ValidateMode]) VALUES ( '4','Reg All Employees','0 - 所有职员','0 - 所有设备',1,'3 - 双门','0 - 卡')
...
INSERT ControllerTemplateHoliday (TemplateId,[HolidayNumber],[HolidayName],[HolidayDate]) VALUES ( 2,3,'耶稣受难节','04-18')
INSERT ControllerTemplateHoliday (TemplateId,[HolidayNumber],[HolidayName],[HolidayDate]) VALUES ( 2,4,'耶稣受难节翌日','04-19')
INSERT ControllerTemplateHoliday (TemplateId,[HolidayNumber],[HolidayName],[HolidayDate]) VALUES ( 2,5,'复活节','04-21')
INSERT ControllerTemplateHoliday (TemplateId,[HolidayNumber],[HolidayName],[HolidayDate]) VALUES ( 2,6,'劳动节','05-01')
INSERT ControllerTemplateHoliday (TemplateId,[HolidayNumber],[HolidayName],[HolidayDate]) VALUES ( 2,7,'佛诞','05-06')
INSERT ControllerTemplateHoliday (TemplateId,[HolidayNumber],[HolidayName],[HolidayDate]) VALUES ( 2,8,'香港特别行政区成立纪念日','07-01')
INSERT ControllerTemplateHoliday (TemplateId,[HolidayNumber],[HolidayName],[HolidayDate]) VALUES ( 2,9,'国庆节','10-02')
INSERT ControllerTemplateHoliday (TemplateId,[HolidayNumber],[HolidayName],[HolidayDate]) VALUES ( 2,10,'圣诞节','12-25')
...
INSERT ControllerTemplateHoliday (TemplateId,[HolidayNumber],[HolidayName],[HolidayDate]) VALUES ( 3,3,'劳动节','05-01')
INSERT ControllerTemplateHoliday (TemplateId,[HolidayNumber],[HolidayName],[HolidayDate]) VALUES ( 3,4,'国庆节','10-01')
INSERT ControllerTemplateHoliday (TemplateId,[HolidayNumber],[HolidayName],[HolidayDate]) VALUES ( 3,5,'国庆节','10-02')
INSERT ControllerTemplateHoliday (TemplateId,[HolidayNumber],[HolidayName],[HolidayDate]) VALUES ( 3,6,'国庆节','10-03')
...
GO
INSERT ControllerTemplateInout ([TemplateId],[InoutPoint],[InoutDesc],[ScheduleID],[ScheduleName],[Out1],[Out2]) VALUES ( 7,1,'Button1',1,'0 - 24H进出',3000,0)
...
INSERT ControllerTemplateInout ([TemplateId],[InoutPoint],[InoutDesc],[Out1],[Out2]) VALUES ( 7,6,'读卡器1-有效卡',3000,0)
INSERT ControllerTemplateInout ([TemplateId],[InoutPoint],[InoutDesc],[Out1],[Out2]) VALUES ( 7,7,'读卡器1-非法卡',0,3000)
INSERT ControllerTemplateInout ([TemplateId],[InoutPoint],[InoutDesc],[Out1],[Out2]) VALUES ( 7,8,'读卡器1-非法时段',0,0)
INSERT ControllerTemplateInout ([TemplateId],[InoutPoint],[InoutDesc],[Out1],[Out2]) VALUES ( 7,9,'读卡器1-防遣返',0,0)
INSERT ControllerTemplateInout ([TemplateId],[InoutPoint],[InoutDesc],[Out1],[Out2]) VALUES ( 7,10,'读卡器2-有效卡',3000,0)
INSERT ControllerTemplateInout ([TemplateId],[InoutPoint],[InoutDesc],[Out1],[Out2]) VALUES ( 7,11,'读卡器2-非法卡',0,3000)
INSERT ControllerTemplateInout ([TemplateId],[InoutPoint],[InoutDesc],[Out1],[Out2]) VALUES ( 7,12,'读卡器2-非法时段',0,0)
INSERT ControllerTemplateInout ([TemplateId],[InoutPoint],[InoutDesc],[Out1],[Out2]) VALUES ( 7,13,'读卡器2-防遣返',0,0)
INSERT ControllerTemplateInout ([TemplateId],[InoutPoint],[InoutDesc],[Out1],[Out2]) VALUES ( 7,14,'门-常开',0,0)
INSERT ControllerTemplateInout ([TemplateId],[InoutPoint],[InoutDesc],[Out1],[Out2]) VALUES ( 7,15,'门-常闭',0,0)	
GO
insert tablefieldcode(FieldId,Content) values( 1,    '中国'   )
...
insert tablefieldcode(FieldId,Content) values( 2,    '香港特别行政区'  )
insert tablefieldcode(FieldId,Content) values( 2,    '澳门特别行政区'  )

insert tablefieldcode(FieldId,Content) values( 3,    '董事长'  )
insert tablefieldcode(FieldId,Content) values( 3,    '总经理'  )
insert tablefieldcode(FieldId,Content) values( 3,    '总监')
insert tablefieldcode(FieldId,Content) values( 3,    '经理'  )
insert tablefieldcode(FieldId,Content) values( 3,    '主管' )
insert tablefieldcode(FieldId,Content) values( 3,    '职员'  )

insert tablefieldcode(FieldId,Content) values( 4,    '总经理（总裁）'  )
insert tablefieldcode(FieldId,Content) values( 4,    '副总经理'  )
insert tablefieldcode(FieldId,Content) values( 4,    '人力资源总监'  )
insert tablefieldcode(FieldId,Content) values( 4,    '财务总监'  )
insert tablefieldcode(FieldId,Content) values( 4,    '营销总监'  )
insert tablefieldcode(FieldId,Content) values( 4,    '市场总监'  )
insert tablefieldcode(FieldId,Content) values( 4,    '销售总监'  )
insert tablefieldcode(FieldId,Content) values( 4,    '运营总监'  )
insert tablefieldcode(FieldId,Content) values( 4,    '技术总监'  )
insert tablefieldcode(FieldId,Content) values( 4,    '总经理助理'  )
insert tablefieldcode(FieldId,Content) values( 4,    '人力资源经理'  )
insert tablefieldcode(FieldId,Content) values( 4,    '招聘主管'  )
insert tablefieldcode(FieldId,Content) values( 4,    '培训师'  )
insert tablefieldcode(FieldId,Content) values( 4,    '绩效考核主管'  )
insert tablefieldcode(FieldId,Content) values( 4,    '薪酬分析师'  )
insert tablefieldcode(FieldId,Content) values( 4,    '财务经理'  )
insert tablefieldcode(FieldId,Content) values( 4,    '核算专员'  )
insert tablefieldcode(FieldId,Content) values( 4,    '出纳员'  )
insert tablefieldcode(FieldId,Content) values( 4,    '簿记员'  )
insert tablefieldcode(FieldId,Content) values( 4,    '行政经理'  )
insert tablefieldcode(FieldId,Content) values( 4,    '秘书'  )
insert tablefieldcode(FieldId,Content) values( 4,    '档案员'  )
insert tablefieldcode(FieldId,Content) values( 4,    '前台'  )
insert tablefieldcode(FieldId,Content) values( 4,    '市场部经理'  )
insert tablefieldcode(FieldId,Content) values( 4,    '客户开发主管'  )
insert tablefieldcode(FieldId,Content) values( 4,    '市场调研主管'  )
insert tablefieldcode(FieldId,Content) values( 4,    '市场拓展经理'  )
insert tablefieldcode(FieldId,Content) values( 4,    '媒介推广专员'  )
insert tablefieldcode(FieldId,Content) values( 4,    '客户代表'  )
insert tablefieldcode(FieldId,Content) values( 4,    '美工'  )
insert tablefieldcode(FieldId,Content) values( 4,    '销售部经理'  )
insert tablefieldcode(FieldId,Content) values( 4,    '销售代表'  )
insert tablefieldcode(FieldId,Content) values( 4,    '销售统计员'  )
insert tablefieldcode(FieldId,Content) values( 4,    '电话销售代表'  )
insert tablefieldcode(FieldId,Content) values( 4,    '研发主管'  )
insert tablefieldcode(FieldId,Content) values( 4,    '计算机管理员'  )
insert tablefieldcode(FieldId,Content) values( 4,    '软件工程师'  )
insert tablefieldcode(FieldId,Content) values( 4,    '高级软件工程师'  )
insert tablefieldcode(FieldId,Content) values( 4,    '测试主管'  )
insert tablefieldcode(FieldId,Content) values( 4,    '软件测试工程师'  )
insert tablefieldcode(FieldId,Content) values( 4,    '数据库工程师'  )
insert tablefieldcode(FieldId,Content) values( 4,    '系统分析员'  )
insert tablefieldcode(FieldId,Content) values( 4,    '网络工程师'  )
insert tablefieldcode(FieldId,Content) values( 4,    '网络管理员'  )
insert tablefieldcode(FieldId,Content) values( 4,    '清洁员'  )
insert tablefieldcode(FieldId,Content) values( 4,    '保安'  )

insert tablefieldcode(FieldId,Content) values( 5,    '小学'  )
insert tablefieldcode(FieldId,Content) values( 5,    '初中'  )
insert tablefieldcode(FieldId,Content) values( 5,    '中专'  )
insert tablefieldcode(FieldId,Content) values( 5,    '高中'  )
insert tablefieldcode(FieldId,Content) values( 5,    '大专'  )
insert tablefieldcode(FieldId,Content) values( 5,    '本科'  )
insert tablefieldcode(FieldId,Content) values( 5,    '硕士'  )
insert tablefieldcode(FieldId,Content) values( 5,    '博士'  )

insert tablefieldcode(FieldId,Content) values( 6,    '0 - 卡'  )
insert tablefieldcode(FieldId,Content) values( 6,    '1 - 指纹'  )
insert tablefieldcode(FieldId,Content) values( 6,    '2 - 卡+指纹'  )
insert tablefieldcode(FieldId,Content) values( 6,    '3 - 卡+密码'  )
GO
...
INSERT [Employees] ([EmployeeId],[DepartmentID],[Card],[Number],[Name],[Sex],[Knowledge],[BirthDate],[Country],[NativePlace],[JoinDate],[Position],[Headship],[IncumbencyStatus]) VALUES ( 1,1,1234,'U001','user1','男','硕士','1900-01-01','中国','北京市','2014-11-10','行政经理','主管','0-在职')
INSERT [Employees] ([EmployeeId],[DepartmentID],[Card],[Number],[Name],[Sex],[Knowledge],[BirthDate],[Country],[NativePlace],[JoinDate],[Position],[Headship],[IncumbencyStatus]) VALUES ( 2,1,1235,'U002','user2','女','硕士','1900-01-01','中国','北京市','2014-11-10','行政经理','主管','0-在职')
...
INSERT [ControllerSchedule] ([RecordID],[ControllerId],[ScheduleCode],[TemplateId],[TemplateName],[Status]) VALUES ( 1,1,1,1,'0 - 24H进出',0)
...
INSERT [ControllerInout] ([RecordID],[ControllerId],[InoutPoint],[InoutDesc],[ScheduleID],[ScheduleName],[Out1],[Out2],[Out3],[Out4],[Out5],[status]) VALUES ( 1,1,1,'Button1',1,'0 - 24H进出',3000,0,0,0,0,0)
...
INSERT [ControllerInout] ([RecordID],[ControllerId],[InoutPoint],[InoutDesc],[Out1],[Out2],[Out3],[Out4],[Out5],[status]) VALUES ( 6,1,6,'读卡器1-有效卡',3000,0,0,0,0,0)
INSERT [ControllerInout] ([RecordID],[ControllerId],[InoutPoint],[InoutDesc],[Out1],[Out2],[Out3],[Out4],[Out5],[status]) VALUES ( 7,1,7,'读卡器1-非法卡',0,0,0,0,0,0)
INSERT [ControllerInout] ([RecordID],[ControllerId],[InoutPoint],[InoutDesc],[Out1],[Out2],[Out3],[Out4],[Out5],[status]) VALUES ( 8,1,8,'读卡器1-非法时段',0,0,0,0,0,0)
INSERT [ControllerInout] ([RecordID],[ControllerId],[InoutPoint],[InoutDesc],[Out1],[Out2],[Out3],[Out4],[Out5],[status]) VALUES ( 9,1,9,'读卡器1-防遣返',0,0,0,0,0,0)
INSERT [ControllerInout] ([RecordID],[ControllerId],[InoutPoint],[InoutDesc],[Out1],[Out2],[Out3],[Out4],[Out5],[status]) VALUES ( 10,1,10,'读卡器2-有效卡',3000,0,0,0,0,0)
INSERT [ControllerInout] ([RecordID],[ControllerId],[InoutPoint],[InoutDesc],[Out1],[Out2],[Out3],[Out4],[Out5],[status]) VALUES ( 11,1,11,'读卡器2-非法卡',0,0,0,0,0,0)
INSERT [ControllerInout] ([RecordID],[ControllerId],[InoutPoint],[InoutDesc],[Out1],[Out2],[Out3],[Out4],[Out5],[status]) VALUES ( 12,1,12,'读卡器2-非法时段',0,0,0,0,0,0)
INSERT [ControllerInout] ([RecordID],[ControllerId],[InoutPoint],[InoutDesc],[Out1],[Out2],[Out3],[Out4],[Out5],[status]) VALUES ( 13,1,13,'读卡器2-防遣返',0,0,0,0,0,0)
INSERT [ControllerInout] ([RecordID],[ControllerId],[InoutPoint],[InoutDesc],[Out1],[Out2],[Out3],[Out4],[Out5],[status]) VALUES ( 14,1,14,'门-常开',0,0,0,0,0,0)
INSERT [ControllerInout] ([RecordID],[ControllerId],[InoutPoint],[InoutDesc],[Out1],[Out2],[Out3],[Out4],[Out5],[status]) VALUES ( 15,1,15,'门-常闭',0,0,0,0,0,0)
